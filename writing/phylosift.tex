...
\begin{figure}[hp]
\begin{center}
\includegraphics[width=6.5in]{figures/all_prettylike.pdf}
\end{center}
\caption{\textbf{Lineages contributing variation to Principal Component 1 in human fecal samples.} 110 metagenomic samples were processed using PhyloSift and their community composition compared using Edge PCA~\cite{MatsenEvans2012}. Lineages that decrease in abundance along PC1 are shown in turquoise color, those increasing in abundance are shown in red. Edge width is proportional to the change in abundance. Remaining lineages in the phylogeny of bacteria, archaea, eukarya, and some viruses are shown in light gray.}
\label{fig:overview}
\end{figure}
