...
Phylogenetic analysis of metagenome sequence could offer several advantages in the area of microbial forensics.
...
Third, the phylogenetic approach can be applied to any gene of interest regardless of whether it is universally conserved or concordant with a taxonomic hierarchy.
...
Although we do not provide examples, it is possible to test the hypothesis that two microbial communities have equal composition using the phylogenetic Kantorovich-Rubenstein distance~\citep{Evans2010}.
